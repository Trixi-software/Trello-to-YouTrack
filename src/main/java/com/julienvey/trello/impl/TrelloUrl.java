...
public class TrelloUrl {
    ...
    public static final String GET_BOARD_ARCHIVED_CARDS = "/boards/{boardId}/cards?filter=closed&";
    ...
    public static final String GET_CARD_COMMENTS = "/cards/{cardId}/actions?filter=commentCard&";
