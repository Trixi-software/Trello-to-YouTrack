...
public class TrelloImpl implements Trello {
    ...
    @Override
    public List<Card> getBoardArchivedCards(String boardId, Argument... args) {
        return asList(() -> get(createUrl(GET_BOARD_ARCHIVED_CARDS).params(args).asString(), Card[].class, boardId));
    }
    ...
    @Override
    public List<CommentToRead> getCardComments(String cardId, Argument... args) {
        return asList(() -> get(createUrl(GET_CARD_COMMENTS).params(args).asString(), CommentToRead[].class, cardId));
    ...
    public Action updateComment(String idCard, String commentActionId, String text) {
        return put(createUrlWithNoArgs(UPDATE_CARD_COMMENT), null, Action.class, idCard, commentActionId);
    }
